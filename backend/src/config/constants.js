...
export const getAtExpirySeconds = () => parseInt(process.env.AT_EXPIRY_SECONDS, 10) || 900;
export const getRtExpirySeconds = () => parseInt(process.env.RT_EXPIRY_SECONDS, 10) || 604800;
export const getRtExpiryMs = () => getRtExpirySeconds() * 1000;
export const getRtByteLength = () => parseInt(process.env.RT_BYTE_LENGTH, 10) || 48;
